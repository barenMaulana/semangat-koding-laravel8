<div>
    <div>
        ...
        @if($isModal)
            @include('livewire.course_video.modal')
        @endif
                ...
                <div class="text-2xl font-bold text-gray-500">
                        ...
                        <div class="flex justify-around pt-5">
                            <div>
                                ...
                                <p> @error('courseTitle') <span class="text-red-500">{{ $message }}</span>@enderror</p>
                            ...
                            <div>
                                <input wire:model="playlistId" type="text" list="playlistId" name="playlistId" class="border-2 border-gray-300 bg-white h-10 px-5 pr-16 rounded-lg text-sm focus:outline-none"  placeholder="Playlist ID">
                                <p> @error('playlistId') <span class="text-red-500">{{ $message }}</span>@enderror</p>
                            </div>
                        </div>
                        <div class="flex justify-around pt-5">
                            <div>
                                <input wire:model="content" type="text" list="content" name="content" class="border-2 border-gray-300 bg-white h-10 px-5 pr-16 rounded-lg text-sm focus:outline-none"  placeholder="Content">
                                <p> @error('content') <span class="text-red-500">{{ $message }}</span>@enderror</p>
                            </div>
                            <div>
                                <input wire:model="trailerId" type="text" list="trailerId" name="trailerId" class="border-2 border-gray-300 bg-white h-10 px-5 pr-16 rounded-lg text-sm focus:outline-none"  placeholder="Trailer ID">
                                <p> @error('trailerId') <span class="text-red-500">{{ $message }}</span>@enderror</p>
                            </div>
                        </div>
                        <div class="flex justify-center pt-5">
                            <div>
                                ...
                                <p> @error('materialDiscussed') <span class="text-red-500">{{ $message }}</span>@enderror</p>
                            </div>
                        </div>
                        @if ($openButton)
                            <div class="flex justify-center py-6">
                                <button wire:click.prevent="store()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded my-3">Add</button>
                            </div>
                        @endif
                </div>
